 ...
 *   It is important to draw the mirror to the stencil buffer after we have drawn the skull(box) so that pixels of the mirror occluded by the skull fail the depth test, and therefore do not modify the stencil buffer. 
 *	 We do not want to turn on parts of the stencil buffer that are occluded; otherwise the reflection will show through the skull.
 *
 *
 *   Controls:
